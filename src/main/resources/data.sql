...
VALUES (1, TRUE, 'user@dev', 'Adic', 'Administrator', '$2a$10$XizdxtpAW8xUbxSW.3q4k.bwhqMOcac8OTm8/vKo0VwzKux/8Smnu',
       ...
       (2, TRUE, 'guest@dev', 'Gosha', 'Guest', '$2a$10$j3WpiyKaAmAbLU//BnrAb.8bijT23gsqBSwLs1hobq8L6b3JPUqmG', 'guest',
        'User Guest', '123123123'),
       (3, TRUE, 'free@dev', 'fedor', 'Free', '$2a$10$j3WpiyKaAmAbLU//BnrAb.8bijT23gsqBSwLs1hobq8L6b3JPUqmG', 'free',
        'User FreeStudent', '123123123'),
       (4, TRUE, 'student@dev', 'Tema', 'Student', '$2a$10$7EmxgswE0zIj6EI/f2zX7eNKP2YBaHGETfZH3vqTUpDMrvg6cQg7y',
        'student', 'User Student', '123123123'),
       (5, TRUE, 'master@dev', 'Stepa', 'Master', '$2a$10$j3WpiyKaAmAbLU//BnrAb.8bijT23gsqBSwLs1hobq8L6b3JPUqmG',
        'master', 'User ScrumMaster', '123123123'),
       (6, TRUE, 'alumnus@dev', 'Alex', 'Alumnus', '$2a$10$j3WpiyKaAmAbLU//BnrAb.8bijT23gsqBSwLs1hobq8L6b3JPUqmG',
        'alumnus', 'User Alumnus', '123123123'),
       (7, TRUE, 'lecturer@dev', 'LecturerLast', 'Lecturer',
        '$2a$10$q0lsQInjeAjygy8ekwxZP.00nacRUMlmkZLd.NP.HD2RJNZm29YPe', 'lecturer', 'User Lecturer', '123123123'),
       (8, TRUE, 'sales@dev', 'SalesLast', 'Sales',
        '$2a$10$5Au2VIbwM9d.n6zut4ZvO.wSB4f6oxuJsPZv6UAQTSJD9XNVX7lyu', 'sales', 'User Sales', '123123123'),
       (90, TRUE, 'user@dev', 'streamCourse_1', 'TeamCourse1',
        '$2a$10$IZgkJaRT8VtWSq9z.9ZjK.6xn1gMn3LiJGscXZDVehkUYoxVW.cva', 'course1User', NULL, '123123123'),
       (91, TRUE, 'user@dev', 'streamCourse_2', 'TeamCourse2',
        '$2a$10$HNyQR8JlouePUG7VX9XHgep25SNu1K3djrJ3Nq6GBCI6TgnWzmHrG', 'course2User', NULL, '123123123'),
       (92, TRUE, 'user@dev', 'streamCourse_3', 'TeamCourse3',
        '$2a$10$j0pPnEbToIFgbSJPnyUlzeyPHeOxvlVoZQpx8m/Vd/68xg5/QAUYG', 'course3User', NULL, '123123123'),
       (93, TRUE, 'user@dev', 'streamCourse_4', 'TeamCourse4',
        '$2a$10$WokgfVPM8AbCvMHwus6C2eqxLh4RYE1bupMwN8gh08CQhS2i9AIv6', 'course4User', NULL, '123123123');
...
(
    ...
    "TELEGRAM_CHAT_TOKEN" VARCHAR(255),
...
CREATE TABLE `PROFILE_POSSESSES`
(
    "ID"          BIGINT NOT NULL,
    "ENTITY_ID"   BIGINT,
...
INSERT INTO `PROFILE_POSSESSES`
VALUES (20, 10, 'PROFILE', 10),
       (21, 30, 'COURSE', 10),
       (22, 40, 'LECTURE', 10),
       (23, 41, 'LECTURE', 10),
       (24, 42, 'LECTURE', 10),
...
INSERT INTO `COURSE`
VALUES (30, 'SubTitleCourse_1', '<p>TEXT</p>', 'Course 1', ''),
...
INSERT INTO `LECTURE`
VALUES (40, 'subtitleLecture_1', '<p>fasdfasdf</p>', 'Lecture_1'),
...
CREATE
SEQUENCE "PUBLIC"."HIBERNATE_SEQUENCE" START
WITH 1000;
...
INSERT INTO `book`
VALUES (1, 'https://www.iconninja.com/files/854/364/1/develop-programming-software-java-language-code-command-icon.png',
        'book1',
        'author1',
        'edition1',
        'publisher1',
...
INSERT INTO redirection_link (UUID, COURSE_ID, LECTURE_ID, STREAM_TEAM_PROFILE_ID, STUDENT_PROFILE_ID,
                              ...
                              TIMESTAMP)
VALUES ('working-aaaa-aaaa-bbbb', 30, 2, 3, 10, 'https://t.me/joinchat/VJHfs-zBDeM7aB9t',
        'http://localhost:19011/redirect/working-aaaa-aaaa-bbbb', 15, 'event name', 'LECTURE', 'NEW',
        '2022-12-31T23:55:59'),
       ('expired-aaaa-aaaa-aaaa', 30, 2, 3, 10, 'https://t.me/joinchat/VJHfs-zBDeM7aB9t',
        'http://localhost:19011/redirect/expired-aaaa-aaaa-aaaa', 15, 'event name', 'LECTURE', 'NEW',
        '2020-12-31T23:40:59'),
       ('used-aaaa-aaaa-aaaa', 30, 2, 4, 10, 'https://t.me/joinchat/VJHfs-zBDeM7aB9t',
        'http://localhost:19011/redirect/used-aaaa-aaaa-aaaa', 15, 'event name', 'LECTURE', 'USED',
        '2020-12-31T23:40:59'),
       ('already-expired-aaaa-aaaa', 30, 2, 4, 10, 'https://t.me/joinchat/VJHfs-zBDeM7aB9t',
        'http://localhost:19011/redirect/already-expired-aaaa-aaaa', 15, 'event name', 'LECTURE', 'EXPIRED',
        '2020-12-31T23:40:59');


CREATE TABLE `stream_and_team_subscriber`
(
    `id`                     bigint(20) NOT NULL,
    `status`                 varchar(255) DEFAULT NULL,
    `stream_team_profile_id` bigint(20)   DEFAULT NULL,
    `subscriber_profile_id`  bigint(20)   DEFAULT NULL,
    PRIMARY KEY (`id`)
);

INSERT INTO `stream_and_team_subscriber`
VALUES (147, 'APPROVED', 16, 10),
       (148, 'REQUESTED', 17, 10);
