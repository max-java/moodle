...
public class View {
    ...
    public static final String CRM_PAGE_STREAMS = "crm/pageStreams";
    public static final String CRM_PAGE_DEBTORS = "crm/pageDebtors";
    public static final String CRM_PAGE_CASH_FLOW = "crm/pageCashFlow";
